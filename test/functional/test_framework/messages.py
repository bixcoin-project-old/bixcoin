...
COIN = 100000000  # 1 bix in satoshis
...
# Objects that map to bixcoind objects, which can be serialized/deserialized
...
class CTransaction:
    ...
    def deserialize(self, f):
        ...
        if len(self.vin) == 0:
            ...
            # matches the implementation in bixcoind
            if (flags != 0):
                self.vin = deser_vector(f, CTxIn)
...
class msg_version:
    ...
    def deserialize(self, f):
        ...
        # But, unconditionally check it to match behaviour in bixcoind
...
class msg_headers:
    ...
    def deserialize(self, f):
        # comment in bixcoind indicates these should be deserialized as blocks
