...
class WalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 BIX from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 100 bix in block rewards plus fees, but
        ...
        # Send 10 BIX with subtract fee from amount
        ...
        # Sendmany 10 BIX with subtract fee from amount
        ...
        # Sendmany 5 BIX to two addresses with subtracting fee from both addresses
        ...
        for target, mode in product([-1, 0], ["bix/kb", "sat/b"]):
