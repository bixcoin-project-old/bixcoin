...
class TransactionTimeRescanTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        minernode = self.nodes[0]  # node used to mine BIX and create transactions
        ...
        # generate some bix to create transactions and check blockcount
        ...
        # send 10 bix to user's first watch-only address
        self.log.info('Send 10 bix to user')
        ...
        # send 5 bix to our second watch-only address
        self.log.info('Send 5 bix to user')
        ...
        # send 1 bix to our third watch-only address
        self.log.info('Send 1 bix to user')
