...
class NetTest(BitcoinTestFramework):
    ...
    def test_getnodeaddresses(self):
        ...
        self.nodes[0].addpeeraddress(address=ipv6_addr, port=9424)
        ...
        for i in range(10000):
            ...
            self.nodes[0].addpeeraddress(a, 9424)
    ...
    def test_addpeeraddress(self):
        ...
        assert_equal(node.addpeeraddress(address="", port=9424), {"success": False})
