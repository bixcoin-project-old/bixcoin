...
This guide describes how to build bixcoind, command-line utilities, and GUI on FreeBSD.
...
#### Wallet Dependencies
It is not necessary to build wallet functionality to run either `bixcoind` or `bixcoin-qt`.
