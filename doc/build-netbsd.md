...
This guide describes how to build bixcoind, command-line utilities, and GUI on NetBSD.
...
It is not necessary to build wallet functionality to run bixcoind or the GUI.

###### Descriptor Wallet Support

`sqlite3` is required to enable support for [descriptor wallets](https://github.com/BitChainCore/bixcoin/blob/master/doc/descriptors.md).
