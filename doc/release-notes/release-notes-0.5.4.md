...
http://gitorious.org/bitcoin/bixcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Bixcoin-Qt notifications under Growl 1.3.
Increase required age of Bixcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBitcoin properly when installing Bixcoin-Qt over it. (Windows)
