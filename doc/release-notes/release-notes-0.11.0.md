...
defaults to 0.00001. This will cause transactions with fewer BIX/kB fee to be
...
For example, add the following to `bixcoin.conf`:
...
- #5809 `46bfbe7` Add bixcoin-cli man page
...
- #5849 `41259ca` contrib/init/bixcoind.openrc: Compatibility with previous OpenRC init script variables
...
- #6116 `30dc3c1` [OSX] rename Bixcoin-Qt.app to Bitcoin-Core.app
- #6168 `b3024f0` contrib/linearize: Support linearization of testnet blocks
- #6098 `7708fcd` Update Windows resource files (and add one for bixcoin-tx)
