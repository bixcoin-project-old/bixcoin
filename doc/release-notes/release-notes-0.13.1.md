...
- **Signature covers value:** A simple improvement in the way signatures are
  ...
  of bixcoins they think they are spending, and by having full nodes refuse to
  accept those signatures unless the amount of bixcoins being spent is exactly
...
- **Increased security for multisig:** Bixcoin addresses (both P2PKH addresses
...
- #8829 `2a8bca4` Add bixcoin-tx JSON tests (jnewbery)
- #8834 `1dd1783` blockstore: Switch to dumb dbm (MarcoFalke)
- #8835 `d87227d` nulldummy.py: Don't run unused code (MarcoFalke)
- #8836 `eb18cc1` bixcoin-util-test.py should fail if the output file is empty (jnewbery)
...
- #8817 `bcf3806` update bixcoin-tx to output witness data (jnewbery)
