...
Since 0.14.0 the approximate transaction fee shown in Bixcoin-Qt when using coin
...
- #10451 `3612219` contrib/init/bixcoind.openrcconf: Don't disable wallet by default (Luke Dashjr)
