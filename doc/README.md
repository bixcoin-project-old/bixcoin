...
- `bin/bixcoin-qt` (GUI) or
- `bin/bixcoind` (headless)

### Windows

Unpack the files into a directory, and then run bixcoin-qt.exe.
...
- [bixcoin.conf Configuration File](bitcoin-conf.md)
