...
If you want to build bixcoin-qt, make sure that the required packages for Qt development
...
Once these are installed, they will be found by configure and a bixcoin-qt executable will be
built by default.
