...
```sh
$ bixcoin-cli createwallet "hww" true true "" true true true
```
...
```sh
$ bixcoin-cli -rpcwallet=<wallet> getnewaddress
$ bixcoin-cli -rpcwallet=<wallet> walletdisplayaddress <address>
```
...
```sh
$ bixcoin-cli -rpcwallet=<wallet> sendtoaddress <address> <amount>
```
