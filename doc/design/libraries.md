...
| Name                     | Description |
|--------------------------|-------------|
| *libbitcoin_cli*         | RPC client functionality used by *bixcoin-cli* executable |
...
| *libbitcoinqt*           | GUI functionality used by *bixcoin-qt* and *bixcoin-gui* executables |
| *libbitcoin_ipc*         | IPC functionality used by *bixcoin-node*, *bixcoin-wallet*, *bixcoin-gui* executables to communicate when [`--enable-multiprocess`](multiprocess.md) is used. |
| *libbitcoin_node*        | P2P and RPC server functionality used by *bixcoind* and *bixcoin-qt* executables. |
| *libbitcoin_util*        | Home for common functionality shared by different executables and libraries. Similar to *libbitcoin_common*, but lower-level (see [Dependencies](#dependencies)). |
| *libbitcoin_wallet*      | Wallet functionality used by *bixcoind* and *bixcoin-wallet* executables. |
| *libbitcoin_wallet_tool* | Lower-level wallet functionality used by *bixcoin-wallet* executable. |
| *libbitcoin_zmq*         | [ZeroMQ](../zmq.md) functionality used by *bixcoind* and *bixcoin-qt* executables. |
...
bixcoin-cli[bixcoin-cli]-->libbitcoin_cli;

bixcoind[bixcoind]-->libbitcoin_node;
bixcoind[bixcoind]-->libbitcoin_wallet;

bixcoin-qt[bixcoin-qt]-->libbitcoin_node;
bixcoin-qt[bixcoin-qt]-->libbitcoinqt;
bixcoin-qt[bixcoin-qt]-->libbitcoin_wallet;

bixcoin-wallet[bixcoin-wallet]-->libbitcoin_wallet;
bixcoin-wallet[bixcoin-wallet]-->libbitcoin_wallet_tool;
...
class bixcoin-qt,bixcoind,bixcoin-cli,bixcoin-wallet bold
```
</td></tr><tr><td>
