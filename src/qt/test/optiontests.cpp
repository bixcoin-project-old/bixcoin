...
void OptionTests::parametersInteraction()
{
    ...
    // With fListen=false in ~/.config/Bitcoin/Bixcoin-Qt.conf and all else left as default,
    // bixcoin-qt should set both -listen and -listenonion to false and start successfully.
