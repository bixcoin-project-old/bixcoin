...
#define QAPP_APP_NAME_DEFAULT "Bixcoin-Qt"
#define QAPP_APP_NAME_TESTNET "Bixcoin-Qt-testnet"
#define QAPP_APP_NAME_SIGNET "Bixcoin-Qt-signet"
#define QAPP_APP_NAME_REGTEST "Bixcoin-Qt-regtest"
