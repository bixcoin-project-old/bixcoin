...
QList<BitcoinUnit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(Unit::BIX);
    unitlist.append(Unit::mBIX);
    unitlist.append(Unit::uBIX);
...
{
    switch (unit) {
    case Unit::BIX: return QString("BIX");
    case Unit::mBIX: return QString("mBIX");
    case Unit::uBIX: return QString::fromUtf8("µBIX (bits)");
...
{
    switch (unit) {
    case Unit::BIX: return longName(unit);
    case Unit::mBIX: return longName(unit);
    case Unit::uBIX: return QString("bits");
...
{
    switch (unit) {
    case Unit::BIX: return QString("Bixcoins");
    case Unit::mBIX: return QString("Milli-Bixcoins (1 / 1" THIN_SP_UTF8 "000)");
    case Unit::uBIX: return QString("Micro-Bixcoins (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
...
{
    switch (unit) {
    case Unit::BIX: return 100'000'000;
    case Unit::mBIX: return 100'000;
    case Unit::uBIX: return 100;
...
{
    switch (unit) {
    case Unit::BIX: return 8;
    case Unit::mBIX: return 5;
    case Unit::uBIX: return 2;
...
{
    switch (unit) {
    case BitcoinUnit::BIX: return 0;
    case BitcoinUnit::mBIX: return 1;
    case BitcoinUnit::uBIX: return 2;
...
{
    switch (num) {
    case 0: return BitcoinUnit::BIX;
    case 1: return BitcoinUnit::mBIX;
    case 2: return BitcoinUnit::uBIX;
