...
# CONFIGFLAGS
CONFIGFLAGS="--enable-sse2 --enable-reduce-exports --disable-bench --disable-gui-tests --disable-fuzz-binary"
...
(
    ...
    (
        ...
        # copy over the example bixcoin.conf file. if contrib/devtools/gen-bitcoin-conf.sh
        # has not been run before buildling, this file will be a stub
        cp "${DISTSRC}/share/examples/bixcoin.conf" "${DISTNAME}/"
