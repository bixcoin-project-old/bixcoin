...
BITCOIND=${BITCOIND:-$BINDIR/bixcoind}
SHARE_EXAMPLES_DIR=${SHARE_EXAMPLES_DIR:-$TOPDIR/share/examples}
EXAMPLE_CONF_FILE=${EXAMPLE_CONF_FILE:-$SHARE_EXAMPLES_DIR/bixcoin.conf}
...
then
  ...
  echo -e "To safely generate a bixcoin.conf file, please commit your changes to $BITCOIND, rebuild, then run this script again.\n"
fi

echo 'Generating example bixcoin.conf file in share/examples/'
...
# parse the output from bixcoind --help
